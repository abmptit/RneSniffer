...
//        //       .AddDbContext<ApplicationDbContext>(options => options.UseSqlite("Data Source=rne.db"))
//        //       .BuildServiceProvider();

//        //    var annee = (args != null && args.Count() > 0) ? args[0] : "2020";
//        //   MergeDataInOneFile(serviceProvider, annee);
//        //}
...
//        {
//            return CreateDe(args)
//                           .ConfigureHostConfiguration(
//                               webBuilder => webBuilder.UseStarretup<Startup>());
//        }
...
//        private static void RecupererSociete(ServiceProvider serviceProvider, string annee)
//        {
//            List<EntrepriseRne> entrepriseModels = new List<EntrepriseRne>();
//            string rootUrlRNE = "https://www.registre-entreprises.tn/search/";
...
//                        try
//                        {
//                            var entreprise = new EntrepriseRne();
...
//                        foreach (var entreprise in entrepriseModels)
//                        {
//                            entreprise.AnneeCreation = annee;
//                            var entrepriseBase = context.EntrepriseRne.Find(entreprise.IdentifiantUnique);
...
//        private static void MergeDataInOneFile(ServiceProvider serviceProvider, string annee)
//        {
...
//            var entrepriseBases = context.EntrepriseRne.ToList();
...
//            var savedEntreprise = context.EntrepriseRne.Where(e => e.AnneeCreation == annee).ToList();
//            var jsonObject = JsonConvert.SerializeObject(savedEntreprise);
//            File.WriteAllText($"Merged_{annee}.json", jsonObject);
